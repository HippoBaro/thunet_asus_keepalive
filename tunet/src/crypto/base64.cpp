...
std::string base64_encode(unsigned char const* bytes_to_encode, unsigned int in_len, std::string base64_chars) {
    std::string ret;
    int i = 0;
    int j = 0;
...
std::string base64_encode(boost::string_view to_encode, std::string base64_chars) {
    return base64_encode(reinterpret_cast<const unsigned char *>(to_encode.cbegin()), static_cast<unsigned int>(to_encode.size()), base64_chars);
}

std::string base64_decode(boost::string_view encoded_string, std::string base64_chars) {
